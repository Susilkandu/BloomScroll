...
export default function Home() {
  ...
  return (
    <div className='home  pt-[1rem] '>
      ...
      <div className="relative pt-[3rem] md:pt-[8rem] flex-col md:flex md:flex-row  md:rounded-tr-[2rem] md:rounded-tl-[2rem] bg-[#00000058]">
        <Plx parallaxData={FstBtn} className="qoutes p-10 rounded-tl-[2rem] rounded-br-[2rem] rounded-bl-[2rem] h-[30vh] sm:pt-[9rem] pl-1.5 sm:pl-[10rem]  font-[fantasy]  sm:items-center w-full">
        ...
        <Plx parallaxData={HeadPlx} className=" w-full sm:pr-[0%] md:pr-[0%] md:mt-[2rem]  ">
      ...
      <div className="flex-col Plx--active mt-[-2rem]  sm:flex sm:flex-row sm:rounded-tr-[2rem] sm:rounded-tl-[2rem] bg-[black]">
        <Plx parallaxData={Qotes} className="qoutes p-2 sm:p-10  md:p-48 rounded-tr-[3rem] rounded-br-[3rem] pt-11 pl-1.5 sm:pl-[10rem]  font-[fantasy] s *: m:flex  sm:items-center bg-gradient-to-b from-black to-blue-900">
        ...
        <div className="w-full pt-[5rem] sm:pt-[4.7%] pb-1.5  sm:pr-[0%] md:pr-[0%] md:mt-[2rem]">
          <img className=' rotate-90 border-[5px] rounded-2xl active:animate-spin' src="/Images/gSeeds/gardening.png" alt="Not Available" />
        </div>
      </div>
      ...
      <div className="mt-[-2rem]  sm:mt-5 flex-col sm:flex sm:flex-row rounded-t-2xl white">
        <div className=" w-full pt-[5rem] sm:pt-[4.7%] pb-1.5   md:pr-[20%] md:mt-[2rem]  ">
          <img className='rotate-90 rounded-4xl border-[5px] animate-bounce  ' src="/Images/gSeeds/success.png" alt="Not Available" />
        </div>
        <div className="qoutes sm:mt-3rem p-10 mt-[2rem] mr-1.5 rounded-tl-[3rem] rounded-tr-[4rem] rounded-bl-[4rem] pt-11 pl-1.5 sm:pl-[10rem]  font-[fantasy] s *: m:flex  sm:items-center bg-gradient-to-b from-black to-blue-900">
      ...
      <div className=" pt-2  sm:pt-[10rem] flex-col sm:flex sm:flex-row bg-radial-[at_100%_100%]  sm:rounded-tr-[2rem] sm:rounded-tl-[2rem] bg-[#00020a]">
